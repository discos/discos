#ifndef SRTWBANDRECEIVERIMPL_H
#define SRTWBANDRECEIVERIMPL_H

/* ************************************************************************************************************* */
/* IRA Istituto di Radioastronomia                                                                               */
/* $Id: SRTWBandReceiverImpl.h,v 1.7 2023-08-01 9:24:44 lorenzo.monti Exp $										 */
/*                                                                                                               */
...
/**
 * This class implements the SRTWBandReceiver CORBA interface and the ACS CharacteristicComponent.  
 ...
 * <br> 
 */
class SRTWBandReceiverImpl: public CharacteristicComponentImpl, public virtual POA_Receivers::SRTWBand {
...
public:
	...
	*/
	SRTWBandReceiverImpl(const ACE_CString &CompName,maci::ContainerServices *containerServices);

	/**
	 * Destructor.
	*/
	virtual ~SRTWBandReceiverImpl(); 
	...
	*/
	//virtual string enable_USB_devs() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string disable_USB_devs() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_w_LO_freq_PolH() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_w_LO_freq_PolV() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_w_LO_PolH() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_w_LO_PolV() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_w_LO_Pols() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_w_LO_Synths_Temp() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_w_LO_HKP_Temp() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_W_LO_RefH() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_W_LO_RefV() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_W_LO_RefH() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_W_LO_RefV() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_w_LO_status() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_LO_att_PolH() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_LO_att_PolV() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_LO_att_PolH() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_LO_att_PolV() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_LO_atts() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_w_home() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_w_solar_attn() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_w_cal() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_w_passthrough() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_w_mod() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string set_IF_switch_config() throw (CORBA::SystemException);
    
	/*
     * Returns a reference to the azimuth property Implementation of IDL interface.
	 * @return pointer to read-only double property azimuth	*/
	//virtual string get_IF_switch_config() throw (CORBA::SystemException);
     /**/
private:
	...
	/**
	 *  socket used to issue commands to the Solar Attenuator
	 */
	CCALSocket m_calSocket;
	/**
	 * socket used to issue commands to the Local Oscillator
	 */
	CLOSocket m_loSocket;
	/**
	* socket used to issue commands to the Switch Matrix
	*/
	CSwMatrixSocket m_swMatrixSocket;
	/**
