...
protected:
    ...
    static double voltage2Kelvin(double voltage) {
        return voltage < 1.12 ? \
                (660.549422889947 * pow(voltage, 6)) - (2552.334255456860 * pow(voltage, 5)) + \
                (3742.529989384570 * pow(voltage, 4)) - (2672.656926956470 * pow(voltage, 3)) + (947.905578508975 * \
                pow(voltage, 2)) - 558.351002849576 * voltage + 519.607622398508 \
                :
                (865.747519105672 * pow(voltage, 6)) - (7271.931957100480 * pow(voltage, 5)) + \
                (24930.666241800500 * pow(voltage, 4)) - (44623.988512320400 * pow(voltage, 3)) + \
                (43962.922216886600 * pow(voltage, 2)) - 22642.245121997700 * voltage + 4808.631312836750;
    }
