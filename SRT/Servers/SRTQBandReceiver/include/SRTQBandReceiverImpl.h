...
#ifndef __SRTQBANDRECEIVERIMPL_H__
#define __SRTQBANDRECEIVERIMPL_H__
...
/** 
 * @mainpage 33GHz SRT QBand Multifeed receiver component Implementation
 * @date 07/10/2011
 * @version 1.1.0
 ...
 * </ul>
 */
class SRTQBandReceiverImpl: public CharacteristicComponentImpl,  public virtual POA_Receivers::SRTQBand {

public:
    
    SRTQBandReceiverImpl(const ACE_CString &CompName, maci::ContainerServices *containerServices);

    virtual ~SRTQBandReceiverImpl(); 
...
private:
    ...
    void operator=(const SRTQBandReceiverImpl &);
