...
public:
    ...
    */
     ...
     * Finally I apply the hex2dec and a degree conversion.
    ...
    /**
     * This member function sets the icd position. The user type the input value as a degree angle
     * ant this method convert it to number of steps needed to address the ICD. The positioning error
     ...
     */
    void setPosition(double position) throw (ComponentErrors::SocketErrorExImpl, MinorServoErrors::PositioningErrorEx);
     ...
     * @throw ComponentErrors::SocketErrorExImpl
     */
    void getDriveStatus() throw (ComponentErrors::SocketErrorExImpl);
...
private:
    ...
    double m_icd_position;

    /** @var read the target position. */
    double m_icd_target_position;
