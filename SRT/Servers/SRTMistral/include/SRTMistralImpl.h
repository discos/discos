#ifndef _SRTMISTRALIMPL_H_
#define _SRTMISTRALIMPL_H_
...
/*                                                                                                              */
/* Who                                when            What                                                      */
/* Carlo Migoni(carlo.migoni@inaf.it) 09/01/2023      Creation                                                  */
...
/** 
 * @mainpage SRTMistral backend component documentation
 * @date 12/02/2013
 * @version 1.61.0
 * @author <a href=mailto:carlo.migoni@inaf.it>Carlo Migoni</a>
 * @remarks Last compiled under ACS 
 * @remarks compiler version is 
*/

class CSenderThread;

/**
 * This class implements the Backends::SRTMistral CORBA interface.  
 ...
 * <br> 
 */
class SRTMistralImpl: public virtual BulkDataSenderDefaultImpl, public virtual POA_Backends::SRTMistral
{
public: 
	/** 
	* Constructor.
	...
	*/
	SRTMistralImpl(const ACE_CString &CompName,maci::ContainerServices *containerServices);
	
	/**
	 * Destructor.
	*/
	virtual ~SRTMistralImpl(); 
	...
	*/
    ...
    virtual void setup() throw (CORBA::SystemException, ComponentErrors::ComponentErrorsEx, BackendsErrors::BackendsErrorsEx);
    virtual void vnaSweep() throw (CORBA::SystemException, ComponentErrors::ComponentErrorsEx, BackendsErrors::BackendsErrorsEx);
    virtual void targetSweep() throw (CORBA::SystemException, ComponentErrors::ComponentErrorsEx, BackendsErrors::BackendsErrorsEx);
	...
	*/	
    ...
    virtual Management::TSystemStatus getManagementStatus() { return m_ManagementStatus; };
...
private:
    ...
    Management::TSystemStatus m_ManagementStatus;

    Backends::MistralDataBlock m_MistralDB;

};

#endif /*SRTMistralImpl_H_*/
