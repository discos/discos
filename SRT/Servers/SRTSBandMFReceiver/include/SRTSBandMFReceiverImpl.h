...
#ifndef __SRTSBANDMFRECEIVERIMPL_H__
#define __SRTSBANDMFRECEIVERIMPL_H__
...
/** 
 * @mainpage 22GHz SRT SBand Multifeed receiver component Implementation
 * @date 07/10/2011
 * @version 1.1.0
 ...
 * </ul>
 */
class SRTSBandMFReceiverImpl: public CharacteristicComponentImpl,  public virtual POA_Receivers::SRTSBandMF {

public:
    
    SRTSBandMFReceiverImpl(const ACE_CString &CompName, maci::ContainerServices *containerServices);

    virtual ~SRTSBandMFReceiverImpl(); 
...
private:
    ...
    void operator=(const SRTSBandMFReceiverImpl &);
