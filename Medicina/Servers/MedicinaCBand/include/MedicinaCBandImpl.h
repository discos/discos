#ifndef __MEDICINACBANDIMPL_H_
#define __MEDICINACBANDIMPL_H_
 ...
 * <br> 
 */
class MedicinaCBandImpl: public baci::CharacteristicComponentImpl,
				   public virtual POA_Receivers::MedicinaCBand
{
public:
	...
	*/
	MedicinaCBandImpl(const ACE_CString &CompName,maci::ContainerServices *containerServices);

	/**
	 * Destructor.
	*/
	virtual ~MedicinaCBandImpl();
