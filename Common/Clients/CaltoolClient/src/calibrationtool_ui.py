...
#
# Created: Fri Dec  2 17:10:19 2011
...
class Ui_CalibrationToolDialog(object):
    def setupUi(self, CalibrationToolDialog):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(700, 591, 181, 31))
        ...
        self.plainTextEdit_project.setGeometry(QtCore.QRect(18, 40, 210, 31))
        ...
        self.plainTextEdit_filename.setGeometry(QtCore.QRect(497, 40, 371, 31))
        ...
        self.plainTextEdit_observer.setGeometry(QtCore.QRect(240, 40, 211, 31))
        ...
        self.groupBox.setGeometry(QtCore.QRect(700, 350, 171, 191))
        ...
        self.doubleSpinBox_hpbw = QtGui.QDoubleSpinBox(self.frame)
        ...
        self.doubleSpinBox_amplitude = QtGui.QDoubleSpinBox(self.frame)
        ...
        self.doubleSpinBox_peakOffset = QtGui.QDoubleSpinBox(self.frame)
        ...
        self.doubleSpinBox_slope = QtGui.QDoubleSpinBox(self.frame)
        self.doubleSpinBox_slope.setObjectName(_fromUtf8("doubleSpinBox_slope"))
        self.formLayout_3.setWidget(4, QtGui.QFormLayout.LabelRole, self.doubleSpinBox_slope)
        self.doubleSpinBox_offset = QtGui.QDoubleSpinBox(self.frame)
        self.doubleSpinBox_offset.setObjectName(_fromUtf8("doubleSpinBox_offset"))
        self.formLayout_3.setWidget(6, QtGui.QFormLayout.LabelRole, self.doubleSpinBox_offset)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.LabelRole, self.frame)
        self.formFrame = QtGui.QFrame(CalibrationToolDialog)
        self.formFrame.setGeometry(QtCore.QRect(710, 100, 149, 219))
        ...
        self.formLayout_2.setWidget(8, QtGui.QFormLayout.FieldRole, self.scanIdLabel)
        self.scanIdLineEdit = QtGui.QLineEdit(self.formFrame)
        self.scanIdLineEdit.setObjectName(_fromUtf8("scanIdLineEdit"))
        self.formLayout_2.setWidget(8, QtGui.QFormLayout.LabelRole, self.scanIdLineEdit)
        spacerItem1 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.formLayout_2.setItem(9, QtGui.QFormLayout.LabelRole, spacerItem1)
        spacerItem2 = QtGui.QSpacerItem(20, 70, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.formLayout_2.setItem(4, QtGui.QFormLayout.LabelRole, spacerItem2)
