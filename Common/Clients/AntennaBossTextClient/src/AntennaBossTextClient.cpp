// $Id: AntennaBossTextClient.cpp,v 1.13 2010-09-20 12:03:37 a.orlati Exp $
...
// This is the CURL of the last generator, used to check if the client needs to release the generator component
IRA::CString lastGenerator="";
