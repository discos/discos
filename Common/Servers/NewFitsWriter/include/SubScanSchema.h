...
#define SCHEMA_HEADER_ENTRY_NUMBER 30
//#define SCHEMA_TABLE_NUMBER 0
//#define SCHEMA_COLUMN_NUMBER 0
//#define SCHEMA_DATA_COLUMN_NUMBER 0
...
#define SCHEMA_HEADER_ENTRY10 ( 0, _FILE_LONG_TYPE,_FILE_SINGLE_ENTRY,"LST","Local sidereal time" )
