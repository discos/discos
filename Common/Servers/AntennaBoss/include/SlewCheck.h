...
/* $Id: SlewCheck.h,v 1.5 2010-10-14 12:23:36 a.orlati Exp $                                                             */
/*                                                                    */
...
public:
	...
	/**
	 *  Method initialises the mount slewing speeds, i.e. the velocities the 
	 * antenna moves at  - in azimuth and elevation - when a new target position
	 * is commanded. Values are in rad, rad/s rad/s^2
	 */
	void initMount(const double& AzRate,const double& ElRate,const double& minEl,const double& maxEl,const double& maxAzAcc,const double& maxElAcc);
	
	/**
	 * Given the object initialisations, The current antenna position and
