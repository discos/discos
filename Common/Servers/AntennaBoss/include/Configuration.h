...
/* $Id: Configuration.h,v 1.9 2010-10-14 12:23:36 a.orlati Exp $                                                                                                                                     */
/*                                                                                                                                                */
...
public:	
	...
	*/	
	const double& getMaxAzimuthAcceleration() { return m_maxAzimuthAccelaration; }
	
	/**
	 * @return the maximum acceleration in elevation (rad/sec^2)
	*/
	const double& getMaxElevationAcceleration() { return m_maxElevationAcceleration; }
