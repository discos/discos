// $Id: SchedulerImpl.cpp,v 1.13 2011-04-15 09:06:59 a.orlati Exp $
...
static char *rcsId="@(#) $Id: SchedulerImpl.cpp,v 1.13 2011-04-15 09:06:59 a.orlati Exp $";
...
void SchedulerImpl::aboutToAbort()
{
 ...
 ACS::doubleSeq *SchedulerImpl::systemTemperature() throw (CORBA::SystemException,ComponentErrors::ComponentErrorsEx)
 {
...
void SchedulerImpl::chooseDefaultBackend(const char *bckInstance)
{
	AUTO_TRACE("SchedulerImpl::chooseDefaultBackend()");
	m_core->chooseDefaultBackend(bckInstance);	
}

void SchedulerImpl::chooseDefaultDataRecorder(const char *rcvInstance)
{
