...
/* $Id: SchedulerImpl.h,v 1.17 2011-04-15 09:06:59 a.orlati Exp $										         */
/*                                                                                                               */
...
public:
	...
	*/	
	 ...
	 */
	virtual ACS::doubleSeq *systemTemperature() throw (CORBA::SystemException,ComponentErrors::ComponentErrorsEx);
	
	/**
	 * It allows to change the name of the instance of the current default backend
	 * @param bckInstance name of the instance 
	*/ 
	virtual void chooseDefaultBackend(const char *bckInstance);
	 ...
	 */
	virtual void chooseDefaultDataRecorder(const char *rcvInstance);
