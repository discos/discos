#ifndef _ROACHIMPL_H_
#define _ROACHIMPL_H_

/* ************************************************************************************************************* */
/* IRA Istituto di Radioastronomia                                                                               */
/* $Id: RoachImpl.h,v 1.1 2011-03-14 14:15:07 a.orlati Exp $										         */
/*                                                                                                               */
...
/** 
 * @mainpage Roach backend component documentation
 * @date 12/02/2013
 * @version 1.61.0
...
/**
 * This class implements the Backends::Roach CORBA interface.  
 ...
 * <br> 
 */
class RoachImpl: public virtual BulkDataSenderDefaultImpl, public virtual POA_Backends::Roach
{
public: 
	/** 
	* Constructor.
	...
	*/
	RoachImpl(const ACE_CString &CompName,maci::ContainerServices *containerServices);
