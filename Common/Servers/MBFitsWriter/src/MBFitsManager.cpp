...
/*
void MBFitsManager::test_createPrimaryHeader( const bool		isGrouping_,
...
//
	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("INSTRUME"),											instrume_								);
		...
		long indexFebe = 1;
		for ( MBFitsManager::FeBe_ci_v_t febeName_ci = febeN_.begin(); febeName_ci != febeN_.end(); ++febeName_ci ) {
			stringstream keyword;
			keyword << "FEBE" << indexFebe;
			primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, keyword.str(), *febeName_ci, string(), string("FEBEn"));
			keyword.str(string());

			++indexFebe;
		}

//	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("FREQn"),												freqN_									);	// TODO - loop sui FEBE
//	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("LINEn"),												lineN_									);	// TODO - loop sui FEBE
//	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("BWIDn"),												bwidN_									);	// TODO - loop sui FEBE
	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("OBJECT"),												object_									);
	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("TIMESYS"),											timeSys_								);
	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("MJD-OBS"),											mjdObs_									);
	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("DATE-OBS"),											dateObs_								);
//	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("RA"),														ra_											);
//	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("DEC"),													dec_										);
	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("RADECSYS"),											radecSys_								);
	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("EQUINOX"),											equinox_								);
	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("EXPTIME"),											expTime_								);
//	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("ORIGFILE"),											origFile_								);
	primaryHeaderGroupingTable_p->setKeywordValue(CMBFitsWriter::Primary, string("PROJID"),												projID_									);
...
void MBFitsManager::test_createScanHeader( const string&	telescop_,
													 const double		siteLong_,
													 const double		siteLat_,
													 const float		siteElev_,
													 const float		diameter_,
...
//													 const float		hyse_
  ...
  m_scanTable_p->setKeywordValue(string("TELESCOP"),	telescop_							);
  m_scanTable_p->setKeywordValue(string("SITELONG"),	siteLong_	* 180.0 / PI);
  m_scanTable_p->setKeywordValue(string("SITELAT"),		siteLat_	* 180.0 / PI);
  m_scanTable_p->setKeywordValue(string("SITEELEV"),	siteElev_							);
  m_scanTable_p->setKeywordValue(string("DIAMETER"),	diameter_							);
  m_scanTable_p->setKeywordValue(string("PROJID"),		projID_								);
  m_scanTable_p->setKeywordValue(string("OBSID"),			obsID_								);
  ...
  m_scanTable_p->setKeywordValue(string("ETUTC"),			etUtc_								);
  m_scanTable_p->setKeywordValue(string("GPSTAI"),		gpsTai_								);
//  m_scanTable_p->setKeywordValue(string("CTYPE1B"),		cType1b_							);
//  m_scanTable_p->setKeywordValue(string("CTYPE2B"),		cType2b_							);
  m_scanTable_p->setKeywordValue(string("WCSNAME"),		wcsName_							);
  m_scanTable_p->setKeywordValue(string("RADESYS"),		radeSys_							);
  m_scanTable_p->setKeywordValue(string("EQUINOX"),		equinox_							);
  m_scanTable_p->setKeywordValue(string("CTYPE1"),		cType1_								);
  m_scanTable_p->setKeywordValue(string("CTYPE2"),		cType2_								);
  m_scanTable_p->setKeywordValue(string("CRVAL1"),		crVal1_								);
  m_scanTable_p->setKeywordValue(string("CRVAL2"),		crVal2_								);
  m_scanTable_p->setKeywordValue(string("CTYPE1N"),		cType1n_							);
  m_scanTable_p->setKeywordValue(string("CTYPE2N"),		cType2n_							);
  m_scanTable_p->setKeywordValue(string("LONPOLE"),		lonPole_							);
  m_scanTable_p->setKeywordValue(string("LATPOLE"),		latPole_							);
  m_scanTable_p->setKeywordValue(string("OBJECT"),		object_								);
  m_scanTable_p->setKeywordValue(string("BLONGOBJ"),	bLongObj_							);
  m_scanTable_p->setKeywordValue(string("BLATOBJ"),		bLatObj_							);
  m_scanTable_p->setKeywordValue(string("LONGOBJ"),		longObj_							);
  m_scanTable_p->setKeywordValue(string("LATOBJ"),		latObj_								);
  m_scanTable_p->setKeywordValue(string("PATLONG"),		patLong_							);
  m_scanTable_p->setKeywordValue(string("PATLAT"),		patLat_								);
  m_scanTable_p->setKeywordValue(string("CALCODE"),		calCode_							);
  m_scanTable_p->setKeywordValue(string("MOVEFRAM"),	moveFram_							);
  m_scanTable_p->setKeywordValue(string("PERIDATE"),	periDate_							);
  m_scanTable_p->setKeywordValue(string("PERIDIST"),	periDist_							);
  m_scanTable_p->setKeywordValue(string("LONGASC"),		longAsc_							);
  m_scanTable_p->setKeywordValue(string("OMEGA"),			omega_								);
  m_scanTable_p->setKeywordValue(string("INCLINAT"),	inclinat_							);
  m_scanTable_p->setKeywordValue(string("ECCENTR"),		eccentr_							);
  ...
  m_scanTable_p->setKeywordValue(string("CROCYCLE"),	croCycle_							);
  m_scanTable_p->setKeywordValue(string("ZIGZAG"),		zigZag_								);
  m_scanTable_p->setKeywordValue(string("TRANDIST"),	tranDist_							);
  m_scanTable_p->setKeywordValue(string("TRANFREQ"),	tranFreq_							);
  m_scanTable_p->setKeywordValue(string("TRANFOCU"),	tranFocu_							);
  m_scanTable_p->setKeywordValue(string("WOBUSED"),		wobUsed_							);
  m_scanTable_p->setKeywordValue(string("WOBTHROW"),	wobThrow_							);
  m_scanTable_p->setKeywordValue(string("WOBDIR"),		wobDir_								);
  m_scanTable_p->setKeywordValue(string("WOBCYCLE"),	wobCycle_							);
  m_scanTable_p->setKeywordValue(string("WOBMODE"),		wobMode_							);
  m_scanTable_p->setKeywordValue(string("WOBPATT"),		wobPatt_							);

  CMBFitsWriter* const scanTable_p = static_cast<CMBFitsWriter* const>(m_scanTable_p);
  ...
  m_scanTable_p->setKeywordValue(string("NFEBE"),			nFebe_								);
  m_scanTable_p->setKeywordValue(string("PDELTAIA"),	pDeltaIa_							);
  m_scanTable_p->setKeywordValue(string("PDELTACA"),	pDeltaCa_							);
  m_scanTable_p->setKeywordValue(string("PDELTAIE"),	pDeltaIe_							);
  m_scanTable_p->setKeywordValue(string("FDELTAIA"),	fDeltaIa_							);
  m_scanTable_p->setKeywordValue(string("FDELTACA"),	fDeltaCa_							);
  m_scanTable_p->setKeywordValue(string("FDELTAIE"),	fDeltaIe_							);
  m_scanTable_p->setKeywordValue(string("IA"),				ia_										);
  m_scanTable_p->setKeywordValue(string("IE"),				ie_										);
  m_scanTable_p->setKeywordValue(string("HASA"),			hasa_									);
  m_scanTable_p->setKeywordValue(string("HACA"),			haca_									);
  m_scanTable_p->setKeywordValue(string("HESE"),			hese_									);
  m_scanTable_p->setKeywordValue(string("HECE"),			hece_									);
  m_scanTable_p->setKeywordValue(string("HESA"),			hesa_									);
  m_scanTable_p->setKeywordValue(string("HASA2"),			hasa2_								);
  m_scanTable_p->setKeywordValue(string("HACA2"),			haca2_								);
  m_scanTable_p->setKeywordValue(string("HESA2"),			hesa2_								);
  m_scanTable_p->setKeywordValue(string("HECA2"),			heca2_								);
  m_scanTable_p->setKeywordValue(string("HACA3"),			haca3_								);
  m_scanTable_p->setKeywordValue(string("HECA3"),			heca3_								);
  m_scanTable_p->setKeywordValue(string("HESA3"),			hesa3_								);
  m_scanTable_p->setKeywordValue(string("NPAE"),			npae_									);
  m_scanTable_p->setKeywordValue(string("CA"),				ca_										);
  m_scanTable_p->setKeywordValue(string("AN"),				an_										);
  m_scanTable_p->setKeywordValue(string("AW"),				aw_										);
//  m_scanTable_p->setKeywordValue(string("HYSA"),			hysa_									);
//  m_scanTable_p->setKeywordValue(string("HYSE"),			hyse_									);
}

void MBFitsManager::test_createFebeParHeader( CMBFitsWriterTable* const febeParTable_p_,
															const string&	febe_,
															const long		scanNum_,
															const string&	dateObs_,
															const string&	dewCabin_,
  ...
  febeParTable_p_->setKeywordValue(string("DEWCABIN"),	dewCabin_	);
  febeParTable_p_->setKeywordValue(string("DEWRTMOD"),	dewRtMod_	);
  febeParTable_p_->setKeywordValue(string("DEWUSER"),		dewUser_	);
  febeParTable_p_->setKeywordValue(string("DEWZERO"),		dewZero_	);
  febeParTable_p_->setKeywordValue(string("FEBEBAND"),	febeBand_	);
  febeParTable_p_->setKeywordValue(string("FEBEFEED"),	febeFeed_	);
  febeParTable_p_->setKeywordValue(string("NUSEBAND"),	nUseBand_	);
  febeParTable_p_->setKeywordValue(string("FDTYPCOD"),	fdTypCod_	);
  ...
  febeParTable_p_->setKeywordValue(string("TBLANK"),		tBlank_		);
  febeParTable_p_->setKeywordValue(string("TSYNC"),			tSync_		);
  febeParTable_p_->setKeywordValue(string("IARX"),			iaRx_			);
  febeParTable_p_->setKeywordValue(string("IERX"),			ieRx_			);
  febeParTable_p_->setKeywordValue(string("HASARX"),		hasa2Rx_	);
  febeParTable_p_->setKeywordValue(string("HACARX"),		hacaRx_		);
  febeParTable_p_->setKeywordValue(string("HESERX"),		heseRx_		);
  febeParTable_p_->setKeywordValue(string("HECERX"),		heceRx_		);
  febeParTable_p_->setKeywordValue(string("HESARX"),		hesaRx_		);
  febeParTable_p_->setKeywordValue(string("HASA2RX"),		hasa2Rx_	);
  febeParTable_p_->setKeywordValue(string("HACA2RX"),		haca2Rx_	);
  febeParTable_p_->setKeywordValue(string("HESA2RX"),		hesa2Rx_	);
  febeParTable_p_->setKeywordValue(string("HECA2RX"),		heca2Rx_	);
  febeParTable_p_->setKeywordValue(string("HACA3RX"),		haca3Rx_	);
  febeParTable_p_->setKeywordValue(string("HECA3RX"),		heca3Rx_	);
  febeParTable_p_->setKeywordValue(string("HESA3RX"),		hesa3Rx_	);
  febeParTable_p_->setKeywordValue(string("NPAERX"),		npaeRx_		);
  febeParTable_p_->setKeywordValue(string("CARX"),			caRx_			);
  febeParTable_p_->setKeywordValue(string("ANRX"),			anRx_			);
  febeParTable_p_->setKeywordValue(string("AWRX"),			awRx_			);
//  febeParTable_p_->setKeywordValue(string("SIG_ONLN"),	sigOnln_	);
//  febeParTable_p_->setKeywordValue(string("REF_ONLN"),	refOnln_	);
//  febeParTable_p_->setKeywordValue(string("SIG_POL"),		sigPol_		);
//  febeParTable_p_->setKeywordValue(string("REF_POL"),		refPol_		);
...
void MBFitsManager::test_saveFebeParBinTableData( CMBFitsWriterTable* const febeParTable_p_,
  ...
  febeParTable_p_->setColumnValue(string("BESECTS"),	beSects_	);
  febeParTable_p_->setColumnValue(string("FEEDTYPE"),	feedType_	);
  febeParTable_p_->setColumnValue(string("FEEDOFFX"),	feedOffX_	);	// TODO - verificare in che unita' di misura sono indicati
  febeParTable_p_->setColumnValue(string("FEEDOFFY"),	feedOffY_	);	// TODO - verificare in che unita' di misura sono indicati
  febeParTable_p_->setColumnValue(string("REFFEED"),	refFeed_	);

  string polTy;
  for ( vector<char>::const_iterator polTy_ci = polTy_.begin(); polTy_ci != polTy_.end(); ++polTy_ci ) {
		polTy += *polTy_ci;
  }
  febeParTable_p_->setColumnValue(string("POLTY"),		polTy			);

  febeParTable_p_->setColumnValue(string("POLA"),			polA_			);
  febeParTable_p_->setColumnValue(string("APEREFF"),	aperEff_	);
  febeParTable_p_->setColumnValue(string("BEAMEFF"),	beamEff_	);
  febeParTable_p_->setColumnValue(string("ETAFSS"),		etafss_		);
  febeParTable_p_->setColumnValue(string("HPBW"),			hpbw_			);
  febeParTable_p_->setColumnValue(string("ANTGAIN"),	antGain_	);
  febeParTable_p_->setColumnValue(string("TCAL"),			tCal_			);
  febeParTable_p_->setColumnValue(string("BOLCALFC"),	bolCalFc_	);
  febeParTable_p_->setColumnValue(string("BEGAIN"),		beGain_		);
...
void MBFitsManager::test_startScan( const MBFitsManager::FeBe_v_t&	febeNames_,
	...
	const string	radecSys = radeSys_;
	...
	test_createPrimaryHeader(m_isGrouping,
														telescop_,
														origin_,
														creator_,
														m_mbFitsVersion,
	...
	test_createScanHeader( 	telescop_,
													 		siteLong_,
													 		siteLat_,
													 		siteElev_,
													 		diameter_,
...
//													 		hyse_
	...
	for ( MBFitsManager::FeBe_ci_v_t febeName_ci = febeNames_.begin(); febeName_ci != febeNames_.end(); ++febeName_ci ) {
		febeParTable_p = new CMBFitsWriterTable(m_primaryHeaderGroupingTable_p, CMBFitsWriter::FebePar);
		febeParTable_p->setFileName(getPath() + *febeName_ci + string("-") + string("FEBEPAR") + string(".fits"));
		febeParTable_p->open();
		...
		m_febeParTables.insert(MBFitsManager::FeBe_MBFitsWriter_p_m_t::value_type(*febeName_ci, febeParTable_p));

		saveScanBinTableData(*febeName_ci);

		test_createFebeParHeader(febeParTable_p,
												*febeName_ci,
												scanNum_,
												dateObs_,
																dewCabin_,
		...
		test_saveFebeParBinTableData(febeParTable_p,
														useBand_,
														nUseFeed_,
														useFeed_,
														beSects_,
...
void MBFitsManager::test_startSubScan( const MBFitsManager::FeBe_v_t& febeNames_,
																	const long		nUseBand_,
																	const long		scanNum_,
																	const long		subsNum_,
																	const string&	dateObs_,
	...
	CMBFitsWriterTable* dataParTable_p		= NULL;
	CMBFitsWriterTable* arrayDataTable_p	= NULL;
	vector<double>::const_iterator bandWid_ci = bandWid_.begin();
	for ( MBFitsManager::FeBe_ci_v_t febeName_ci = febeNames_.begin(); febeName_ci != febeNames_.end(); ++febeName_ci ) {
		dataParTable_p = new CMBFitsWriterTable(m_primaryHeaderGroupingTable_p, CMBFitsWriter::DataPar);
		dataParTable_p->setFileName(subPath.str() + *febeName_ci + string("-") + string("DATAPAR") + string(".fits"));
		dataParTable_p->open();
		...
		test_createDataParHeader(dataParTable_p,
												scanNum_,
												subsNum_,
												dateObs_,
												*febeName_ci,
		...
		for ( long indexBaseband = 0; indexBaseband < nUseBand_; ++indexBaseband ) {
			stringstream basebandName;
			basebandName << setw(2) << setfill('0') << (indexBaseband + 1);
			...
			test_createArrayDataHeader(arrayDataTable_p,
														*febeName_ci,
														indexBaseband + 1,
														scanNum_,
														subsNum_,
...
void MBFitsManager::test_integrationParameters( const string& febeName_,
																					 const double	mjd_,
																					 const double	lst_,
																					 const double	integTim_,
															const long		phase_,
	...
	test_saveDataParBinTableData(dataParTable_i->second,
															 mjd_,
															 lst_,
															 integTim_,
															 phase_,
...
void MBFitsManager::test_createDataParHeader( CMBFitsWriterTable* const dataParTable_p_,
															const long 		scanNum_,
															const long 		subsNum_,
//															const long 		obsNum_,
															const string&	dateObs_,
...
void MBFitsManager::test_saveDataParBinTableData( CMBFitsWriterTable* const dataParTable_p_,
																									const double	mjd_,
																									const double	lst_,
																									const double	integTim_,
																									const long		phase_,
  ...
  dataParTable_p_->setColumnValue(string("INTEGTIM"),		integTim_	);
  dataParTable_p_->setColumnValue(string("PHASE"),			phase_		);
  dataParTable_p_->setColumnValue(string("LONGOFF"),		longOff_	);
  dataParTable_p_->setColumnValue(string("LATOFF"),			latOff_		);
  dataParTable_p_->setColumnValue(string("AZIMUTH"),		azimuth_	);
  dataParTable_p_->setColumnValue(string("ELEVATIO"),		elevatio_	);
  dataParTable_p_->setColumnValue(string("RA"),					ra_				);
  dataParTable_p_->setColumnValue(string("DEC"),				dec_			);
  dataParTable_p_->setColumnValue(string("PARANGLE"),		parAngle_	);
  dataParTable_p_->setColumnValue(string("CBASLONG"),		cBasLong_	);
  dataParTable_p_->setColumnValue(string("CBASLAT"),		cBasLat_	);
  dataParTable_p_->setColumnValue(string("BASLONG"),		basLong_	);
  dataParTable_p_->setColumnValue(string("BASLAT"),			basLat_		);
  dataParTable_p_->setColumnValue(string("ROTANGLE"),		rotAngle_	);
  dataParTable_p_->setColumnValue(string("MCRVAL1"),		mcrVal1_	);
  dataParTable_p_->setColumnValue(string("MCRVAL2"),		mcrVal2_	);
  dataParTable_p_->setColumnValue(string("MLONPOLE"),		mLonPole_	);
  dataParTable_p_->setColumnValue(string("MLATPOLE"),		mLatPole_	);
  dataParTable_p_->setColumnValue(string("DFOCUS_X"),		dFocus_x_	);
  dataParTable_p_->setColumnValue(string("DFOCUS_Y"),		dFocus_y_	);
  dataParTable_p_->setColumnValue(string("DFOCUS_Z"),		dFocus_z_	);
  dataParTable_p_->setColumnValue(string("DPHI_X"),			dPhi_x_		);
  dataParTable_p_->setColumnValue(string("DPHI_Y"),			dPhi_y_		);
  dataParTable_p_->setColumnValue(string("DPHI_Z"),			dPhi_z_		);
  dataParTable_p_->setColumnValue(string("WOBDISLN"),		wobDisLn_	);
  dataParTable_p_->setColumnValue(string("WOBDISLT"),		wobDisLt_	);

	dataParTable_p_->setRowIndex(dataParTable_p_->getRowIndex() + 1);
}

void MBFitsManager::test_createArrayDataHeader( CMBFitsWriterTable* const arrayDataTable_p_,
																const string&	febe_,
																const long		baseBand_,
																const long		scanNum_,
																const long		subsNum_,
...
//	arrayDataTable_p_->setKeywordValue(string("OBSNUM"),		obsNum_		);
	...
	// Next we assign to the specral axis a frequency and velocity description relative to the rest frame
	// But other alternatives axes descriptions could also be given
	arrayDataTable_p_->setKeywordValue(string("WCSNM2F"),		wcsnm2f_	);
	arrayDataTable_p_->setKeywordValue(string("1CTYP2F"),		_1ctyp2f_	);
	arrayDataTable_p_->setKeywordValue(string("1CRPX2F"),		_1crpx2f_	);
	arrayDataTable_p_->setKeywordValue(string("1CRVL2F"),		_1crvl2f_	);
	arrayDataTable_p_->setKeywordValue(string("11CD2F"),		_11cd2f_	);
	arrayDataTable_p_->setKeywordValue(string("1CUNI2F"),		_1cuni2f_	);
	arrayDataTable_p_->setKeywordValue(string("1SPEC2F"),		_1spec2f_	);
	arrayDataTable_p_->setKeywordValue(string("1SOBS2F"),		_1sobs2f_	);
	arrayDataTable_p_->setKeywordValue(string("WCSNM2R"),		wcsnm2r_	);
	arrayDataTable_p_->setKeywordValue(string("1CTYP2R"),		_1ctyp2r_	);
	arrayDataTable_p_->setKeywordValue(string("1CRPX2R"),		_1crpx2r_	);
	arrayDataTable_p_->setKeywordValue(string("1CRVL2R"),		_1crvl2r_	);
	arrayDataTable_p_->setKeywordValue(string("11CD2R"),		_11cd2r_	);
	arrayDataTable_p_->setKeywordValue(string("1CUNI2R"),		_1cuni2r_	);
	arrayDataTable_p_->setKeywordValue(string("1SPEC2R"),		_1spec2r_	);
	arrayDataTable_p_->setKeywordValue(string("1SOBS2R"),		_1sobs2r_	);
	arrayDataTable_p_->setKeywordValue(string("1VSOU2R"),		_1vsou2r_	);
	arrayDataTable_p_->setKeywordValue(string("1VSYS2R"),		_1vsys2r_	);
}
*/
