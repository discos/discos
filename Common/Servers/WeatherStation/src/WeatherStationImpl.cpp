...
{
//         AUTO_TRACE("WeatherStationImpl::cleanUp()");
...
//		_ADD_BACKTRACE(ManagementErrors::CommandLineErrorExImpl,impl,ex,"WeatherStationImpl::command()");
...
Weather::parameters WeatherStationImpl::getData() throw (ACSErr::ACSbaseEx,CORBA::SystemException)
{
...
ACS::RWdouble_ptr
WeatherStationImpl::temperature ()
...
ACS::RWdouble_ptr
WeatherStationImpl::windspeedpeak ()
    throw (CORBA::SystemException)
{
