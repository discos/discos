#ifndef _ACTIVESURFACEBOSSSECTORTHREAD_H_
#define _ACTIVESURFACEBOSSSECTORTHREAD_H_

/*************************************************************************************/
/* OAC Osservatorio Astronomico di Cagliari                                          */
/* $Id: ActiveSurfaceBossSector1Thread.h,v 1.1 2010-07-26 12:36:49 c.migoni Exp $ */
/*                                                                                   */
...
*/
class CActiveSurfaceBossSectorThread : public ACS::Thread
{
public:
    /**
     * Constructor().
    ...
    */
    CActiveSurfaceBossSectorThread(const ACE_CString& name, CActiveSurfaceBossCore *param,
     ...
     * Destructor.
    */
    ~CActiveSurfaceBossSectorThread();
