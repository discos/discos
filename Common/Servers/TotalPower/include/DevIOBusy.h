...
/* $Id: DevIOBusy.h,v 1.1 2011-03-14 14:15:07 a.orlati Exp $									           */
/*                                                                                                      */
...
public:
	...
	*/ 
	Management::TBoolean read(ACS::Time& timestamp)
	{
		// get the CommandLine .......
	...
	*/ 
	void write(const Management::TBoolean& value, ACS::Time& timestamp)
	{
