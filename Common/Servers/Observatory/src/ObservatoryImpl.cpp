// $Id: ObservatoryImpl.cpp,v 1.5 2010-09-14 09:38:29 a.orlati Exp $
...
static char *rcsId="@(#) $Id: ObservatoryImpl.cpp,v 1.5 2010-09-14 09:38:29 a.orlati Exp $";
...
IRAIDL::TSiteInformation ObservatoryImpl::getSiteSummary() throw (CORBA::SystemException)
{
	AUTO_TRACE("ObservatoryImpl::getSiteSummary()");
	CSecAreaResourceWrapper<T_DevDataBlock> data=m_data->Get();	
	IRAIDL::TSiteInformation tmp=data->site.getSummary();
	tmp.DUT1=data->dut1;
	return tmp;	
}
