...
public:
      ...
      virtual ~SolarSystemBodyImpl();
       ...
       configuration files/parameters, builds up connection.
         ...
         */
        void getAttributes(Antenna::SolarSystemBodyAttributes_out att)  ;     
        
        
        void setBodyName(const char* bodyName)   ;
         ...
         */     
        void setOffsets(CORBA::Double lon,CORBA::Double lat,Antenna::TCoordinateFrame frame)  ;
         ...
         */
        void getHorizontalCoordinate(ACS::Time time, CORBA::Double_out az, CORBA::Double_out el)  ;
		...
		*/
        void getJ2000EquatorialCoordinate(ACS::Time time, CORBA::Double_out ra, CORBA::Double_out dec)  ;
        ...
        */
        void getAllCoordinates(ACS::Time time,CORBA::Double_out az,CORBA::Double_out el,CORBA::Double_out ra,CORBA::Double_out dec,CORBA::Double_out jepoch,
                        CORBA::Double_out lon,CORBA::Double_out lat)  ;
       ...
       the frequency so it must be provided by the caller.
         ...
         */
        bool checkTracking(ACS::Time time,CORBA::Double az,CORBA::Double el,CORBA::Double HPBW)  ;
     ...
     */ 
    void computeFlux(CORBA::Double freq, CORBA::Double fwhm, CORBA::Double_out flux)  ;
  	/**
    ...
    void getDistance(ACS::Time time,CORBA::Double_out distance)  ;
...
private:
      ...
      std::unique_ptr<xephemlib::Site> m_sitex;
      std::unique_ptr<xephemlib::SolarSystemBody> m_body_xephem;      
