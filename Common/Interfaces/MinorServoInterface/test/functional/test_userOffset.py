...
class TestUserOffset(unittest2.TestCase):
    ...
    def test_wrong_servo_name(self):
        ...
        with self.assertRaises(MinorServoErrorsEx):
            self.boss.setUserOffset('SRP_TX', 0)
    ...
    def test_get_offset(self):
        ...
        target_offset = 5.0
        self.boss.setUserOffset('SRP_TX', target_offset)
        offset = self.boss.getUserOffset()[0] # SRP_TX has index 0
