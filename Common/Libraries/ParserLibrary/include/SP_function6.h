...
/* $Id: SP_function6.h,v 1.4 2010-09-13 16:41:21 a.orlati Exp $											*/
/*                                                                                                      */
...
#ifndef _SP_FUNCTION6_H_
#define _SP_FUNCTION6_H_

#include "SP_functor.h"

namespace SimpleParser {

template<class OBJ,_sp_const_function CONST_SPEC,class RT,class A0,class A1,class A2,class A3,class A4,class A5> class function6: public _SP_FUNCTOR
{
public:
	enum {arity=6};
	...
	typedef return_type (OBJ::*normal_func_type)(param0,param1,param2,param3,param4,param5);
	...
	function6(OBJ *object, func_type func) : _SP_FUNCTOR(object),m_func(func) {};
	...
	void call(IRA::CString *params,const WORD& parLen) throw (
		...
		try {
			...
			_ADD_BACKTRACE(ParserErrors::ConversionErrorExImpl,impl,err,"function6::call()");
			throw impl;
		}
		catch (...) {
			_THROW_EXCPT(ParserErrors::ConversionErrorExImpl,"function6::call()");
		}
		retVal=(*_SP_FUNCTOR::m_obj.*m_func)(p0,p1,p2,p3,p4,p5); //can throw a generic exception
	}
...
template<class OBJ,_sp_const_function CONST_SPEC,class A0,class A1,class A2,class A3,class A4,class A5> 
class function6<OBJ,CONST_SPEC,void_type,A0,A1,A2,A3,A4,A5>: public _SP_FUNCTOR
{
public:
	enum {arity=6};
	...
	void call(IRA::CString *params,const WORD& parLen) throw (
		...
		(*_SP_FUNCTOR::m_obj.*m_func)(p0,p1,p2,p3,p4,p5); //can throw a generic exception
	}
	WORD get(IRA::CString *params)  {
		int n=0;
		if (A0::isOutput) {
