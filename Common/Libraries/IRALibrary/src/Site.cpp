// $Id: Site.cpp,v 1.4 2007-06-05 14:37:48 a.orlati Exp $
...
CSite::CSite(): m_longitude(0),m_latitude(0),m_height(0),m_cartX(0),m_cartY(0),m_cartZ(0),m_xP(0),m_yP(0),m_trueLong(0),
  m_trueLat(0),m_deltaAz(0)
{
...
CSite::CSite(const IRAIDL::TSiteInformation& site)
{
...
IRAIDL::TSiteInformation CSite::getSummary()
{
	IRAIDL::TSiteInformation temp;
